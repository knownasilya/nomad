...
import V53 from './schemas/profile-data.v53.sql';
import V54 from './schemas/profile-data.v54.sql';
...
migrations = [
  ...
  migration(V14),
  migration(V15),
  migration(V16, { canFail: true }), // set canFail because we made a mistake in the rollout of this update, see https://github.com/beakerbrowser/nomad/issues/934
  migration(V17),
  migration(V18),
  migration(V19),
  migration(V20),
