...
async function beakerProtocol(request, respond) {
  ...
  if (requestUrl.startsWith('beaker://start/')) {
    return cb(
      ...
      'text/html',
      () =>
        `<!doctype html><meta http-equiv="refresh" content="0; url=beaker://desktop/">`
    );
  }
  ...
  if (requestUrl === 'beaker://assets/logo-black.svg') {
    return cb(
      ...
      'OK',
      'image/svg+xml',
      path.join(__dirname, 'assets/img/logo-black.svg')
    );
  }
  if (requestUrl === 'beaker://assets/spinner.gif') {
    return cb(
      ...
      'OK',
      'image/gif',
      path.join(__dirname, 'assets/img/spinner.gif')
    );
  }
  ...
  if (requestUrl.startsWith('beaker://assets/default-user-thumb')) {
    return cb(
      ...
      'OK',
      'image/jpeg',
      path.join(__dirname, 'assets/img/default-user-thumb.jpg')
    );
  }
  ...
  if (requestUrl.startsWith('beaker://assets/search-icon-large')) {
    return cb(
      ...
      'OK',
      'image/jpeg',
      path.join(__dirname, 'assets/img/search-icon-large.png')
    );
  }
  if (requestUrl.startsWith('beaker://assets/favicons/')) {
    return serveICO(
      path.join(
        __dirname,
        'assets/favicons',
        requestUrl.slice('beaker://assets/favicons/'.length)
      )
    );
  }
  if (requestUrl.startsWith('beaker://assets/search-engines/')) {
    return cb(
      ...
      path.join(
        ...
        requestUrl.slice('beaker://assets/search-engines/'.length)
      )
    );
  }
  if (requestUrl.startsWith('beaker://assets/img/templates/')) {
    ...
    return cb(
      ...
      'OK',
      'image/png',
      path.join(__dirname, `assets/img/templates/${imgPath}`)
    );
  }
  if (requestUrl.startsWith('beaker://assets/img/frontends/')) {
    ...
    return cb(
      ...
      'OK',
      'image/png',
      path.join(__dirname, `assets/img/frontends/${imgPath}`)
    );
  }
  if (requestUrl.startsWith('beaker://assets/img/drive-types/')) {
    ...
    return cb(
      ...
      'OK',
      'image/png',
      path.join(__dirname, `assets/img/drive-types/${imgPath}`)
    );
  }

  // userland
  if (
    requestUrl === 'beaker://app-stdlib' ||
    requestUrl.startsWith('beaker://app-stdlib/')
  ) {
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'app-stdlib'),
      cb
    );
  }
  if (
    requestUrl === 'beaker://diff' ||
    requestUrl.startsWith('beaker://diff/')
  ) {
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'diff'),
      cb
    );
  }
  if (
    requestUrl === 'beaker://library' ||
    requestUrl.startsWith('beaker://library/')
  ) {
    return serveAppAsset(
      requestUrl,
  ...
  if (
    requestUrl === 'beaker://drive-view' ||
    requestUrl.startsWith('beaker://drive-view/')
  ) {
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'drive-view'),
      cb
    );
  }
  if (
    requestUrl === 'beaker://cmd-pkg' ||
    requestUrl.startsWith('beaker://cmd-pkg/')
  ) {
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'cmd-pkg'),
      cb
    );
  }
  if (
    requestUrl === 'beaker://site-info' ||
    requestUrl.startsWith('beaker://site-info/')
  ) {
    return serveAppAsset(
      requestUrl,
  ...
  if (
    requestUrl === 'beaker://setup' ||
    requestUrl.startsWith('beaker://setup/')
  ) {
    return serveAppAsset(
      requestUrl,
  ...
  if (
    requestUrl === 'beaker://init' ||
    requestUrl.startsWith('beaker://init/')
  ) {
    return serveAppAsset(
      requestUrl,
  ...
  if (
    requestUrl === 'beaker://editor' ||
    requestUrl.startsWith('beaker://editor/')
  ) {
    return serveAppAsset(
      requestUrl,
  ...
  if (
    requestUrl === 'beaker://explorer' ||
    requestUrl.startsWith('beaker://explorer/')
  ) {
    return serveAppAsset(
      requestUrl,
  ...
  if (
    requestUrl === 'beaker://hypercore-tools' ||
    requestUrl.startsWith('beaker://hypercore-tools/')
  ) {
    return serveAppAsset(
      requestUrl,
  ...
  if (
    requestUrl === 'beaker://webterm' ||
    requestUrl.startsWith('beaker://webterm/')
  ) {
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'webterm'),
      cb,
      {
        fallbackToIndexHTML: true,
        CSP: SIDEBAR_CSP,
  ...
  if (
    requestUrl === 'beaker://desktop' ||
    requestUrl.startsWith('beaker://desktop/')
  ) {
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'desktop'),
      cb,
      {
        CSP: BEAKER_APP_CSP,
        fallbackToIndexHTML: true,
  ...
  if (
    requestUrl === 'beaker://history' ||
    requestUrl.startsWith('beaker://history/')
  ) {
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'history'),
      cb
    );
  }
  if (
    ...
    return serveAppAsset(
      requestUrl,
      path.join(__dirname, 'userland', 'settings'),
      cb
    );
  }
  if (requestUrl.startsWith('beaker://assets/img/onboarding/')) {
    ...
    return cb(
      ...
      'OK',
      'image/png',
      path.join(__dirname, `assets/img/onboarding/${imgPath}`)
    );
  }
  ...
  if (
    requestUrl.startsWith('beaker://assets/vs/') &&
