...
export const setup = function (rpc) {
  ...
  const beakerBrowserRPC = rpc.importAPI('nomad-browser', beakerBrowserManifest, opts);
  ...
  internal.browser.createEventsStream = () =>
  ...
  internal.hyperdebug.createCoreEventStream = (key) =>
