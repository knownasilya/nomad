...
class SelectDriveModal extends LitElement {
        ...
        <form @submit=${this.onSubmit}>
          ...
          <div class="view drive-picker">
            ...
            <div class="filter-container">
              ...
              <input
                @keyup=${this.onChangeTitleFilter}
                id="filter"
                class="filter"
                type="text"
          ...
          <div class="form-actions">
            <div class="left">
              ${this.writable !== false && !this.allowMultiple
                ? html`
                    <button
                      type="button"
                      @click=${this.onClickCreate}
                      data-content="newdrive"
                      class="btn"
                    >
                      Create new drive
                    </button>
  ...
  renderFilters() {
    ...
    return html` <div class="tag-container">
      <strong>
        ...
        ${typeof this.writable !== 'undefined'
          ? html` ${this.writable ? 'editable' : 'read-only'} `
          : ''}
  ...
  renderDrivesList() {
    if (!this.drives) {
      return html`<ul class="drives-list">
