...
export const ANALYTICS_SERVER = 'analytics.nomad.pages.dev';
export const ANALYTICS_CHECKIN_INTERVAL = ms('6h');

// hyperdrive FS file paths
export const PATHS = {
  BOOKMARKS: '/bookmarks',
  TRASH: '/nomad/trash.json',
};
...
export const DRIVE_CONFIGURABLE_FIELDS = ['title', 'description', 'author'];

// workspace settings
export const WORKSPACE_VALID_NAME_REGEX = /^[a-z][a-z0-9-]*$/i;

// git-url validator
export const IS_GIT_URL_REGEX =
