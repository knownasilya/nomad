 ...
 */
  button {
    ...
    --bg-color--transparent-button--pressed: rgba(0, 0, 0, 0.1);
    ...
    --box-shadow-color--button: rgba(0, 0, 0, 0.05);
    --box-shadow-color--button--hover: rgba(0, 0, 0, 0.5);
    --box-shadow-color--transparent-button: rgba(0, 0, 0, 0.25);
