    ...
    return html`
      ...
      <div class="filter-control">
        <input
          ...
          id="search-input"
          name="url"
          placeholder="Search my history or input a URL"
          @keyup=${(e) => delay(this.onChangeQuery.bind(this), e)}
        />
      </div>
      <main>
  ...
  renderHistoryItem(item) {
    ...
    return html`
      <a
        ...
        class="suggestion"
        title=${title}
        @click=${this.onClickHistory}
        @contextmenu=${this.onContextMenuHistory}
      >
