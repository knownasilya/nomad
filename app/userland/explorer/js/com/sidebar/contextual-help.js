...
export class ContextualHelp extends LitElement {
  ...
  get targetDrive() {
    ...
    if (this.selection.length === 1 && this.selection[0].mount)
      return this.selection[0].mount;
  ...
  render() {
    ...
    return html`
      <section class="help">
        <table>
          ${this.renderUrlCtrl()} ${this.renderVisibilityHelp()}
  ...
  renderUrlCtrl() {
    return html`
      <tr>
        <td
          class="tooltip-right"
          data-tooltip="Click here to copy the URL"
          @click=${this.onClickCopyUrl}
  ...
  renderVisibilityHelp() {
    return html`<tr>
      ...
      <td>Anyone with the link can view this ${this.targetItemLabel}.</td>
    </tr>`;
  }
  ...
  renderIsWritableHelp() {
    if (this.targetDrive.writable) {
      return html`<tr>
        <td><span class="fas fa-fw fa-pen"></span></td>
        <td>Only you can edit this ${this.targetItemLabel}.</td>
      </tr>`;
    }
    return html`<tr>
      <td><span class="fas fa-fw fa-eye"></span></td>
      <td>You can not edit this ${this.targetItemLabel}.</td>
    </tr>`;
  }
