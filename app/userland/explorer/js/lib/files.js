...
async function doCopyOrMove({ sourceItem, targetFolder }, op) {
  ...
  var sourceDrive = nomad.fs.drive(sourceItemParsed.hostname);
  let targetFolderParsed = new URL(targetFolder);
  var targetDrive = nomad.fs.drive(targetFolderParsed.hostname);
