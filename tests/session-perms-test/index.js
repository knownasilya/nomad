async function main() {
  ...
  doLog(
    true,
    'query /pages .md',
    beaker.index.gql(`query { records (paths: ["/pages/*.md"]) { url } }`)
  );
  doLog(
    true,
    'query /microblog .md',
    beaker.index.gql(`query { records (paths: ["/microblog/*.md"]) { url } }`)
  );
  doLog(
    true,
  ...
  doLog(
    true,
    'count /pages .md',
    beaker.index.gql(`query { recordCount (paths: ["/pages/*.md"]) }`)
  );
  doLog(
    true,
    'count /microblog .md',
    beaker.index.gql(`query { recordCount (paths: ["/microblog/*.md"]) }`)
  );
  doLog(
    true,
  ...
  var pub = beaker.hyperdrive.drive(
  ...
  doLog(
    true,
    'stat(/pages/decribing-beaker.md) private',
    priv.stat('/pages/decribing-beaker.md')
  );
  ...
  doLog(
    true,
    'readFile(/pages/decribing-beaker.md) private',
    priv.readFile('/pages/decribing-beaker.md')
  );
  doLog(
    false,
  ...
  await doLog(
    true,
    'writeFile(/beaker-tests/test/hello.txt) private',
    priv.writeFile('/beaker-tests/test/hello.txt', 'world')
  );
  await doLog(
    true,
    'writeFile(/beaker-tests/test/hello.txt) public',
    pub.writeFile('/beaker-tests/test/hello.txt', 'world')
  );
  await doLog(
    false,
    'writeFile(/beaker-tests/test/hello.json) private',
    priv.writeFile('/beaker-tests/test/hello.json', 'world')
  );
  await doLog(
    false,
    'writeFile(/beaker-tests/test/hello.json) public',
    pub.writeFile('/beaker-tests/test/hello.json', 'world')
  );
  await doLog(
    false,
  ...
  await doLog(
    true,
    'copy(/beaker-tests/test/hello.txt, /beaker-tests/test/hello2.txt) private',
    priv.copy('/beaker-tests/test/hello.txt', '/beaker-tests/test/hello2.txt')
  );
  await doLog(
    true,
    'copy(/beaker-tests/test/hello.txt, /beaker-tests/test/hello2.txt) public',
    pub.copy('/beaker-tests/test/hello.txt', '/beaker-tests/test/hello2.txt')
  );
  await doLog(
    true,
    'rename(/beaker-tests/test/hello2.txt, /beaker-tests/test/hello3.txt) private',
    priv.rename(
      '/beaker-tests/test/hello2.txt',
      '/beaker-tests/test/hello3.txt'
    )
  );
  await doLog(
    true,
    'rename(/beaker-tests/test/hello2.txt, /beaker-tests/test/hello3.txt) public',
    pub.rename('/beaker-tests/test/hello2.txt', '/beaker-tests/test/hello3.txt')
  );
  await doLog(
    true,
    'unlink(/beaker-tests/test/hello3.txt) private',
    priv.unlink('/beaker-tests/test/hello3.txt')
  );
  await doLog(
    true,
    'unlink(/beaker-tests/test/hello3.txt) public',
    pub.unlink('/beaker-tests/test/hello3.txt')
  );

  await doLog(
    false,
    'copy(/beaker-tests/test/hello.txt, /pages/hello.md) private',
    priv.copy('/beaker-tests/test/hello.txt', '/pages/hello.md')
  );
  await doLog(
    false,
    'copy(/beaker-tests/test/hello.txt, /pages/hello.md) public',
    pub.copy('/beaker-tests/test/hello.txt', '/pages/hello.md')
  );

  await doLog(
    false,
    'symlink(/index.json, /beaker-tests/test/index.txt) private',
    priv.symlink('/index.json', '/beaker-tests/test/index.txt')
  );
  await doLog(
    true,
    'symlink(/index.json, /beaker-tests/test/index.txt) public',
    pub.symlink('/index.json', '/beaker-tests/test/index.txt')
  );
  await doLog(
    true,
    'unlink(/beaker-tests/test/index.txt) public',
    pub.unlink('/beaker-tests/test/index.txt')
  );

  await doLog(
    false,
    'symlink(/beaker-tests/test/hello.txt, /pages/hello.md) private',
    priv.symlink('/beaker-tests/test/hello.txt', '/pages/hello.md')
  );
  await doLog(
    false,
    'symlink(/beaker-tests/test/hello.txt, /pages/hello.md) public',
    pub.symlink('/beaker-tests/test/hello.txt', '/pages/hello.md')
  );

  await doLog(
    true,
    'copy(/pages/decribing-beaker.md, /beaker-tests/test/describing-beaker.txt) private',
    priv.copy(
      '/pages/decribing-beaker.md',
      '/beaker-tests/test/describing-beaker.txt'
    )
  );
  await doLog(
    true,
    'copy(/pages/test-page.md, /beaker-tests/test/test-page.txt) public',
    pub.copy('/pages/test-page.md', '/beaker-tests/test/test-page.txt')
  );

  await doLog(
    true,
    'unlink(/beaker-tests/test/hello.txt) private',
    priv.unlink('/beaker-tests/test/hello.txt')
  );
  await doLog(
    true,
    'unlink(/beaker-tests/test/hello.txt) public',
    pub.unlink('/beaker-tests/test/hello.txt')
  );
  await doLog(
    false,
    'unlink(/beaker-tests/test/hello.json) private',
    priv.unlink('/beaker-tests/test/hello.json')
  );
  await doLog(
    false,
    'unlink(/beaker-tests/test/hello.json) public',
    pub.unlink('/beaker-tests/test/hello.json')
  );
  await doLog(
    false,
  ...
  await doLog(
    false,
    'mkdir(/beaker-tests/test/sub)',
    priv.mkdir('/beaker-tests/test/sub')
  );
  await doLog(
    false,
    'mkdir(/beaker-tests/test/sub)',
    pub.mkdir('/beaker-tests/test/sub')
  );
